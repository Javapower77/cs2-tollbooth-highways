...
namespace TollboothHighways.Domain.Components
{
    ...
    [ComponentMenu("TollHighways/", new Type[] { typeof(WithNoneAttribute) })]
    public class TollRoadAllVehiclesInfo : ComponentBase
    {
        public override void GetArchetypeComponents(HashSet<ComponentType> components)
        {
            components.Add(ComponentType.ReadWrite<TollRoadAllVehiclesData>());
        }
    ...
    public struct TollRoadAllVehiclesData : IComponentData
    {
        // This is a marker component - no data needed
        // Indicates the entity is for service vehicles
    }
