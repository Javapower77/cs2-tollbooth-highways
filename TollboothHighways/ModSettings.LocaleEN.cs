        ...
        public class LocaleEN : IDictionarySource
        {
            ...
            public Dictionary<string, string> Load(bool dumpTranslations = false)
            {
                return new Dictionary<string, string>
                {
                    ...
                    // Checkboxs
                    { _setting.GetOptionLabelLocaleID(nameof(ModSettings.ChargePublicVehicles)), "Apply toll cost to public transport." },
                    { _setting.GetOptionDescLocaleID(nameof(ModSettings.ChargePublicVehicles)), "Fee will be applied to taxis and buses passing through a tollbooth." },
                    { _setting.GetOptionLabelLocaleID(nameof(ModSettings.ChargeServiceVehicles)), "Apply toll cost to services vehicles." },
                    { _setting.GetOptionDescLocaleID(nameof(ModSettings.ChargeServiceVehicles)), "Fee will be applied to services vehicles passing through a tollbooth." },
